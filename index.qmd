...
1.  (Weekly) **zyBooks reading preparation**: you'll perform these readings as a preparation for a new unit on Fridays. Pay attention to the text and practice with the interactive exercises.
2.  (Weekly) **Perusall perspective reading**: you'll read an article commenting on common themes in programming and their wider societal implications. After this reading, you will be asked to make comments on the text and interact with your colleagues responses. Try not to do it just for the sake of getting the assignment done and get the grade;
3.  (Weekly) **POGIL**: when introducing a new Unit on **every Friday**, we will proceed according to a POGIL approach (Process Oriented Guided Inquiry Learning). We will form teams of three students in order to solve a set of questions and exercises. The teams will need to have:
...
4.  (Weekly) **Labs**: we'll go through a series of programming assignments during our lab classes on Tuesdays. These are posted as assignments in [zyBooks](https://learn.zybooks.com/zybook/CALVINCS104Fall2023), where you and you partner will also submit your solutions.
...
5.  (Weekly) **Quizzes**: usually on Wednesdays, we will have a 15 to 20 minute quiz on Moodle reviewing and applying the concepts we got from the unit.
6.  (Every other week, starting week 2) **Homework**: these will also be posted as assignments on our [zyBooks](https://learn.zybooks.com/zybook/CALVINCS104Fall2023) course page.
