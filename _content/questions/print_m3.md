- Which line of code correctly prints a message that includes both a variable `temperature` and a descriptive text "The current temperature is:" with no extra spaces between the text and the variable?
